...
class GlucoseMonitorApp:
    ...
    def _build_ui(self):
        ...
        # estilo para botón de acción peligrosa (rojo)
        ...
        # borde verde para "Agregar lectura"
        ...
        # padding interno para que se vea el borde del frame
        btn_add.grid(row=0, column=0, padx=3, pady=3, sticky="we")

        # borde rojo para "Resetear semana" y botón con estilo Danger.TButton
